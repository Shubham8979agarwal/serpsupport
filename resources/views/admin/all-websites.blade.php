         ...
         <div class="col-md-12">
            <div class="card card-round">
               <div class="card-body p-4">
                  <table id="all_websites" class="table">
                     <thead>
                        <tr>
                           <th>Website URL</th>
                           <th>Website Niche</th>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a onclick="return confirm('Are you sure?')" href="delete-website/{{ encrypt($aw->id) }}" class="mb-2 btn btn-danger"><i class="fa fa-trash"></i> Delete Website</a>
                           </td>
                        </tr>
                        @endforeach
                        @endif
